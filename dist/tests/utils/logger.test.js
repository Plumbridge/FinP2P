...
describe('Logger', () => {
    ...
    describe('createLogger', () => {
        ...
        it('should create logger with custom format', () => {
            const logger = (0, logger_1.createLogger)({ level: 'info', file: 'test.log' });
    ...
    describe('logging levels', () => {
        it('should log info messages', () => {
            ...
            if (consoleWasCalled) {
                ...
                expect(consoleSpy).toHaveBeenCalledWith(expect.stringContaining('info: Info with data'));
            }
            else if (stdoutWasCalled) {
                expect(processStdoutSpy).toHaveBeenCalledWith(expect.stringContaining('info: Test info message'));
                expect(processStdoutSpy).toHaveBeenCalledWith(expect.stringContaining('info: Info with data'));
            }
            else {
        ...
        it('should log error messages', () => {
            ...
            expect(processStdoutSpy).toHaveBeenCalledWith(expect.stringContaining('error: Test error message'));
            expect(processStdoutSpy).toHaveBeenCalledWith(expect.stringContaining('error: Error with stack'));
        });
        it('should log warning messages', () => {
            const logger = (0, logger_1.createLogger)({ level: 'warn' });
            logger.warn('Test warning message');
            logger.warn('Warning with data', { warning: true });
            expect(processStdoutSpy).toHaveBeenCalledWith(expect.stringContaining('warn: Test warning message'));
            expect(processStdoutSpy).toHaveBeenCalledWith(expect.stringContaining('warn: Warning with data'));
        });
        it('should log debug messages when level allows', () => {
            const logger = (0, logger_1.createLogger)({ level: 'debug' });
            logger.debug('Test debug message');
            logger.debug('Debug with context', { context: 'test' });
            expect(processStdoutSpy).toHaveBeenCalledWith(expect.stringContaining('debug: Test debug message'));
            expect(processStdoutSpy).toHaveBeenCalledWith(expect.stringContaining('debug: Debug with context'));
        });
    ...
    describe('structured logging', () => {
        it('should handle object metadata', () => {
            ...
            expect(processStdoutSpy).toHaveBeenCalledWith(expect.stringContaining('info: User action'));
            expect(processStdoutSpy).toHaveBeenCalledWith(expect.stringContaining('user-123'));
        });
        it('should handle error objects', () => {
            ...
            expect(processStdoutSpy).toHaveBeenCalledWith(expect.stringContaining('error: Operation failed'));
        });
        it('should handle nested objects', () => {
            ...
            expect(processStdoutSpy).toHaveBeenCalledWith(expect.stringContaining('transfer-123'));
        });
    });
    describe('performance logging', () => {
        it('should log performance metrics', () => {
            ...
            expect(processStdoutSpy).toHaveBeenCalledWith(expect.stringContaining('transfer_validation'));
        });
        it('should handle timing information', async () => {
            ...
            expect(processStdoutSpy).toHaveBeenCalledWith(expect.stringContaining('debug: Operation completed'));
        });
    });
    describe('security logging', () => {
        ...
        it('should log access control events', () => {
            ...
            expect(processStdoutSpy).toHaveBeenCalledWith(expect.stringContaining('transfer-endpoint'));
        });
    });
    describe('correlation IDs', () => {
        it('should support correlation ID tracking', () => {
            ...
            const correlationCalls = calls.filter(log => log.includes(correlationId));
    ...
    describe('error handling', () => {
        it('should handle circular references in objects', () => {
            ...
            expect(processStdoutSpy).toHaveBeenCalledWith(expect.stringContaining('[Circular]'));
        });
        ...
        it('should handle very large objects', () => {
            ...
            expect(processStdoutSpy).toHaveBeenCalledWith(expect.stringContaining('item-0'));
        });
    });
});
