...
const HederaAdapter_1 = require("../../src/adapters/HederaAdapter");
...
describe('HederaAdapter', () => {
    ...
    beforeEach(async () => {
        ...
        adapter = new HederaAdapter_1.HederaAdapter(config, logger);
    ...
    describe('Initialization', () => {
        it('should initialize with correct properties', () => {
            ...
            expect(adapter.type).toBe(types_1.LedgerType.HEDERA);
        ...
        it('should use operator as treasury when treasury not provided', () => {
            ...
            expect(() => new HederaAdapter_1.HederaAdapter(configWithoutTreasury, logger)).not.toThrow();
        });
        it('should throw error for invalid network', () => {
            ...
            const invalidAdapter = new HederaAdapter_1.HederaAdapter(invalidConfig, logger);
    ...
    describe('Connection Management', () => {
        it('should handle connection for different networks', async () => {
            ...
            for (const network of networks) {
                ...
                const networkAdapter = new HederaAdapter_1.HederaAdapter(config, logger);
    ...
    describe('Transfer Operations', () => {
        it('should throw error when transferring while disconnected', async () => {
            await expect(adapter.transfer('0.0.123456', '0.0.789012', 'asset-id', BigInt(100))).rejects.toThrow('Not connected to Hedera network');
        });
        ...
        it('should handle lock/unlock operations while disconnected', async () => {
            await expect(adapter.lockAsset('0.0.123456', 'asset-id', BigInt(100))).rejects.toThrow('Not connected to Hedera network');
            await expect(adapter.unlockAsset('0.0.123456', 'asset-id', BigInt(100))).rejects.toThrow('Not connected to Hedera network');
        });
    });
...
//# sourceMappingURL=HederaAdapter.test.js.map