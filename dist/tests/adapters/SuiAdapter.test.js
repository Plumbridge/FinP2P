...
const SuiAdapter_1 = require("../../src/adapters/SuiAdapter");
...
describe('SuiAdapter', () => {
    ...
    beforeEach(() => {
        ...
        adapter = new SuiAdapter_1.SuiAdapter(config, logger);
    ...
    describe('Initialization', () => {
        it('should initialize with correct properties', () => {
            ...
            expect(adapter.type).toBe(types_1.LedgerType.SUI);
        ...
        it('should handle missing private key gracefully', () => {
            ...
            expect(() => new SuiAdapter_1.SuiAdapter(configWithoutKey, logger)).not.toThrow();
        });
    });
    ...
    describe('Asset Operations', () => {
        it('should throw error when creating asset while disconnected', async () => {
            ...
            await expect(adapter.createAsset(assetData)).rejects.toThrow('Not connected to Sui network');
        });
    ...
    describe('Transfer Operations', () => {
        it('should throw error when transferring while disconnected', async () => {
            // Set adapter to disconnected state
            adapter.connected = false;
            await expect(adapter.transfer('from-account', 'to-account', 'asset-id', BigInt(100))).rejects.toThrow('Not connected to Sui network');
        });
        it('should execute transfer with valid parameters', async () => {
            ...
            expect(adapter.client.signAndExecuteTransaction).toHaveBeenCalled();
        });
    });
...
//# sourceMappingURL=SuiAdapter.test.js.map