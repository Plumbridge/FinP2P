...
exports.getConfig = exports.FinP2PRouter = void 0;
const dotenv_1 = __importDefault(require("dotenv"));
const Router_1 = require("./router/Router");
Object.defineProperty(exports, "FinP2PRouter", { enumerable: true, get: function () { return Router_1.FinP2PRouter; } });
    ...
    return {
        ...
        ledgers: {
            ...
            ...(process.env.HEDERA_ACCOUNT_ID && {
                hedera: {
                    type: types_1.LedgerType.HEDERA,
                    config: {
...
async function main() {
    try {
        ...
        const router = new Router_1.FinP2PRouter(config);
