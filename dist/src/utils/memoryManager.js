...
exports.EnhancedCacheManager = exports.MemoryManager = void 0;
/**
 * Comprehensive memory management system for active transfers and leak prevention
 */
class MemoryManager {
    constructor(logger, performanceMonitor, options = {}) {
     ...
     */
    registerTransfer(id, data, status = 'pending') {
...
class EnhancedCacheManager {
    constructor(logger, maxMemoryMB = 100) {
