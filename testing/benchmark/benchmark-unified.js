    ...
    async benchmarkFinP2PAdapterMode() {
        ...
        for (let i = 0; i < this.testParams.iterations; i++) {
            ...
            try {
                ...
                const account1SuiAddress = await this.router.getWalletAddress('account1@atomic-swap.demo', 'sui');
                const account2SuiAddress = await this.router.getWalletAddress('account2@atomic-swap.demo', 'sui');
                ...
                results.transfers.push({
                    ...
                    from_finid: 'account1@atomic-swap.demo',
                    to_finid: 'account2@atomic-swap.demo',
                    from_address: account1SuiAddress,
                    to_address: account2SuiAddress,
